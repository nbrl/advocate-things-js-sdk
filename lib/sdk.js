;(function (context) {
     ...
     * TODO: Handle case when url token is the same as the returned token - i.e.
     *       that token is used up and a new one must be generated and appended.
    ...
    var appendKeyToUrl = function (sharepointData) {
        ...
        // For now, just assign the first sharepoint_token we find.
        ...
        xhr.onload = function () {
            ...
            if (/^20[0-9]{1}/.test(xhr.status)) {
                ...
                if (pointType.name === types.Sharepoint.name) {
                    // TODO: conditional here so client can turn this off.
                    appendKeyToUrl(parsed);
                }
